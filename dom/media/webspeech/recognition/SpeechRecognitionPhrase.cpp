...
SpeechRecognitionPhrase::SpeechRecognitionPhrase(nsIGlobalObject* aGlobal, const nsAString& aPhrase, float aBoost)
...
already_AddRefed<SpeechRecognitionPhrase> SpeechRecognitionPhrase::Constructor(
  ...
  RefPtr<SpeechRecognitionPhrase> phrase = new SpeechRecognitionPhrase(global, aPhrase, aBoost);
