...
extern "C" {
    ...
    PARAKEET_API struct parakeet_context * parakeet_init_from_fd_with_params    (int fd,                                struct parakeet_context_params params);
    ...
    PARAKEET_API struct parakeet_context * parakeet_init_from_fd_with_params_no_state    (int fd,                                struct parakeet_context_params params);
