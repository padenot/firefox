...
extern "C" {
    ...
    // Initialize from file descriptor - the fd should be positioned at the beginning of the model file
    WHISPER_API struct whisper_context * whisper_init_from_fd_with_params    (int fd,                                struct whisper_context_params params);
    ...
    WHISPER_API struct whisper_context * whisper_init_from_fd_with_params_no_state    (int fd,                                struct whisper_context_params params);
    ...
    WHISPER_DEPRECATED(
        WHISPER_API struct whisper_context * whisper_init_from_fd(int fd),
        "use whisper_init_from_fd_with_params instead"
    );
