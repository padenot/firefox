...
extern "C" {
    ...
    // Initialize from file handle - the file handle should be positioned at the beginning of the model file
    // The caller is responsible for closing the file handle
    WHISPER_API struct whisper_context * whisper_init_from_file_handle_with_params(FILE * file,                     struct whisper_context_params params);
    ...
    WHISPER_API struct whisper_context * whisper_init_from_file_handle_with_params_no_state(FILE * file,                     struct whisper_context_params params);
    ...
    WHISPER_DEPRECATED(
        WHISPER_API struct whisper_context * whisper_init_from_file_handle(FILE * file),
        "use whisper_init_from_file_handle_with_params instead"
    );
    WHISPER_DEPRECATED(
        WHISPER_API struct whisper_context * whisper_init_from_file_handle_no_state(FILE * file),
        "use whisper_init_from_file_handle_with_params_no_state instead"
    );
