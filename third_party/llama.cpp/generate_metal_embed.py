...
def main(output, *args):
    ...
    common_h_path = args[0]
    impl_h_path = args[1]
    metal_src_path = args[2]
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print("Usage: generate_metal_embed.py <output.s> <ggml-common.h> <ggml-metal-impl.h> <ggml-metal.metal>", file=sys.stderr)
        sys.exit(1)
